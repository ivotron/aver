		...
		func() bool {
			position38, tokenIndex38, depth38 := position, tokenIndex, depth
			{
				...
				l41:
					...
					depth--
					add(ruleliteral, position40)
				}
				depth--
				add(rulepredicate, position39)
			}
			return true
		l38:
